...
I'll start with this [basic example](https://github.com/Patrick-ring-motive/import-data/blob/main/basic-example.js). Calling `IMPORTDATA` is relatively straight forward. Let's step through each piece.
